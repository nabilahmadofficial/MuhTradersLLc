...
class Photo_Collection_Slider extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Photo Collection Slider', 'sandbox' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'meta_1',
			[
				'label' => __( 'Meta 1', 'sandbox' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '5 Photos', 'sandbox' ),
			]
		);
		$repeater->add_control(
			'meta_2',
			[
				'label' => __( 'Meta 2', 'sandbox' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Wedding', 'sandbox' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'View Gallery', 'sandbox' ),
			]
		);
