 ...
 */
class Sandbox_Sidepanel extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Side Panel', 'sandbox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'bg_panel',
			[
				'label' => __( 'Background Panel', 'sandbox' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'bg_close',
			[
				'label' => __( 'Background Close Button', 'sandbox' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'color_close',
			[
				'label' => __( 'Color Close Button', 'sandbox' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the Sandbox_Sidepanel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Sandbox_Sidepanel() );