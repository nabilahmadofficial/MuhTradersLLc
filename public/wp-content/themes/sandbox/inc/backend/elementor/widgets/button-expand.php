 ...
 * Widget Name: Button
 */
class Sandbox_Button_Expand extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Button Expand', 'sandbox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'icon_size',
			[
				'label' => esc_html__( 'Icon Size', 'sandbox' ),
...
// After the Sandbox_Button_Expand class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Sandbox_Button_Expand() );