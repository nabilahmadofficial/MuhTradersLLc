...
/**
 * Widget Name: Latest Posts Carousel 2
 */
class Latest_Posts_Slider2 extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'ot-latest-posts-carousel_2';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return __( 'OT Latest Posts Carousel 2', 'sandbox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'posts_show_number',
			[
				'label' => __( 'Show Number Post', 'sandbox' ),
		...
		$this->add_control(
			'exc_lenght',
			[
				'label' => __( 'Excerpt Lenght', 'sandbox' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 16,
				'condition' => [
					'is_exc' => 'yes'
	...
	protected function render() {
		...
		$this->add_render_attribute(
			'slides', [
				'class'               => 'ot-carousel ot-latest-post-carousel style-3',
							...
							<div class="card shadow-lg">
								...
								<div class="card-body p-6">
							        ...
							        <div class="post-content">
							        	<p><?php echo sandbox_excerpt( $settings['exc_lenght'] ); ?></p>
							        </div>
						        	<?php } ?>
						        	<div class="post-footer">
							        	<?php sandbox_post_meta(); ?>
							        </div>
						        </div>
...
// After the Latest_Posts_Slider2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Latest_Posts_Slider2() );