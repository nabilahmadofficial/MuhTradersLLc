 ...
 */
class Sandbox_Menu_Mobile extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Menu Mobile', 'sandbox' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pos_menu',
			[
				'label' => __( 'Position', 'sandbox' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'on-right',
				'options' => [
					'on-left' 	=> __( 'On Left', 'sandbox' ),
					'on-right'  => __( 'On Right', 'sandbox' ),
				]
			]
		);
		$this->add_control(
			'logo_text',
			[
				'label' => __( 'Logo Text', 'sandbox' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'default' => __( 'Sandbox', 'sandbox' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => __( 'info@email.com', 'sandbox' ),
				'default' => __( 'info@email.com', 'sandbox' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => __( 'info@email.com', 'sandbox' ),
					],
					[
						'text' => __( '00 (123) 456 78 90', 'sandbox' ),
					],
				],
				'title_field' => '{{{ text }}}',
			]
		...
		$this->add_control(
			'color_back',
			[
				'label' => __( 'Background Close', 'sandbox' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the Sandbox_Menu_Mobile class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Sandbox_Menu_Mobile() );